...
function xeng_sp_top_config(this_block)
  ...
  input_width = bitwidth*2*1*(2^p_factor_bits); %bitwidth*{r/i}*{single_pol}*parallel samples
  output_width = (2*1)*((bitwidth*2+1)+p_factor_bits+serial_acc_len_bits); %r/i}*{1 stokes}*(cmult_width+bit_growth+)
  output_width_uncorr = (2*1)*((bitwidth*2+1)+p_factor_bits+serial_acc_len_bits); %r/i}*{1 stokes}*(cmult_width+bit_growth)
  ...
  this_block.addFile([source_root_path, '/general_lib/dp_ram.v']);
  this_block.addFile([source_root_path, '/general_lib/bram_delay_behave.v']);
  this_block.addFile([source_root_path, '/general_lib/dsp_acc.v']);
  ...
  this_block.addFile([source_root_path, '/xeng_lib/dsp48e_mac_chain.v']);
  this_block.addFile([source_root_path, '/xeng_lib/cmac.v']);
  this_block.addFile([source_root_path, '/xeng_lib/single_pol_cmac.v']);
  this_block.addFile([source_root_path, '/xeng_lib/bl_order_gen.v']);
  this_block.addFile([source_root_path, '/xeng_lib/auto_tap.v']);
  this_block.addFile([source_root_path, '/xeng_lib/baseline_tap.v']);
  this_block.addFile([source_root_path, '/xeng_lib/component_tracker_sp.v']);

  this_block.addFile([source_root_path, '/xeng_lib/xeng_sp_top.v']);
return;
