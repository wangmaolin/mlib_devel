...
reuse_block(blk, 'auto_tap', 'ox_lib/xeng/auto_tap', ...
...
for i=1:floor(n_ants/2),
        ...
        reuse_block(blk, name, 'ox_lib/xeng/baseline_tap', ...
            'n_ants',num2str(n_ants), ...            
            'n_bits',num2str(n_bits), ...
            'acc_len',num2str(acc_len), ...
            'add_latency',num2str(add_latency), ...
...
reuse_block(blk, 'sample_and_hold2', 'casper_library/Misc/sample_and_hold', 'Position', [x + 100,190,x+140,250],...
            'period',sprintf('%d',n_ants * acc_len));

reuse_block(blk, 'sample_and_hold3', 'casper_library/Misc/sample_and_hold', 'Position', [x + 250,190,x+290,250],...
            'period',sprintf('%d',n_ants * acc_len));
...
if (n_ants == 4)
    reuse_block(blk, 'xeng_descramble_4ant', 'casper_library/Correlator/xeng_descramble_4ant', ...
...
elseif (n_ants >=6)
    reuse_block(blk, 'xeng_descramble', 'casper_library/Correlator/xeng_descramble', ...
        'Position', [x + 100, 105, x + 200, 163], ...
