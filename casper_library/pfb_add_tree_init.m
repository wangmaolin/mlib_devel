...
reuse_block(blk, 'convert1', 'xbsIndex_r4/Convert', ...
    ...
    'overflow', 'Saturate', 'latency', num2str(CAST_LATENCY), 'pipeline', 'on',...
...
reuse_block(blk, 'delay1', 'xbsIndex_r4/Delay', ...
    ...
    %in the pfb_fir (complex) block this isn't right. The adder tree doesn't allow bit growth,
    % so we only scale back by 1.
