...
if strcmp(delays_bram, 'on'),
  ...
  fan_latency = max(1, ceil(log2(n_brams/max_fanout)));
...
latency = 1;
if strcmp(async, 'off') && strcmp(delays_bram, 'on'), latency = 1 + fan_latency + bram_latency;
end
...
if strcmp(delays_bram, 'on'),
  ...
  for n=1:2,
    ...
    reuse_block(blk, delay, 'casper_library_bus/bus_single_port_ram', ...
      ...
      'din_register', 'on', 'din_implementation', 'core', ...
      'force_we_one', 'on', ...
      'Position', dpos{n}); 
